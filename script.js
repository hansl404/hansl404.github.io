...
const translations = [
	...
	['.nav nav a:nth-of-type(3)', '여행지'],
	['.nav nav a:nth-of-type(4)', '작업'],
	['.nav-contact', '연락하기 <span aria-hidden="true">↗</span>'],
	['.hero .eyebrow', '개발자 · 언어 학습자 · 사람을 잇는 사람'],
	...
	['.profile-bottom > p', '기술은 제 배경입니다.<br>언어는 평생 이어갈 탐구입니다.'],
	...
	['.education:nth-of-type(3) .eyebrow', '추가 교육'],
	...
	['.timeline article:nth-child(2) > p:not(.company)', 'AI 및 서비스 혁신 팀의 프로젝트 관리를 지원했습니다. Azure DevOps 사용자 스토리와 백로그를 정리해 언어를 일관되게 유지하고 애자일 업무를 지원했습니다.'],
	...
	['#contact h2', '함께<br><em>유용한 것</em>을 만듭니다.'],
